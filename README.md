...
Version 6.0.3 carries the board-era world assembly path: per-zone routing is
stable for the recursive overlap fixture, `WorldGeometryResolver` owns
multi-zone geometry harmonization, and `BoardWorldMaterializedSolution` owns the
materialized world geometry/wiring output used by the current inspect surface.
...
materialization, render, and world composition.
